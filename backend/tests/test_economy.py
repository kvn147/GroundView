...
from backend.agents.agent_economy import retrieve_evidence
...
async def main():
    ...
    print("Testing Economy Agent with Search Grounding...")
    
    # Test claim
    claim = "The US national debt is growing at an unsustainable rate."
