...
async def retrieve_evidence(claim: str) -> str:
    ...
    sources_text = get_sources_for_domain("economy")
    
    system_instruction = f"""
    You are an expert research assistant specializing in economy, demographic data, and policy.
    ...
    4. Mention the likely sources (like BLS, FRED, Census Bureau, Pew Research, etc.) for this information.
    """
